...
Version  : 3.0.7
Release  : 12
URL      : https://github.com/clearcontainers/shim/archive/3.0.7.tar.gz
Source0  : https://github.com/clearcontainers/shim/archive/3.0.7.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1510243552
