...
Version  : 3.0.5
Release  : 10
URL      : https://github.com/clearcontainers/shim/archive/3.0.5.tar.gz
Source0  : https://github.com/clearcontainers/shim/archive/3.0.5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1509059389
